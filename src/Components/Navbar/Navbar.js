  ...
  return (
    <nav className={ishamburge !== false ? "navactive" : null}>
      ...
      <ul className={ishamburge !== false ? "ulactive" : null}>
        ...
        {storeContext.userEmailData === "amanthapliyal14@gmail.com" ? (
          <li>
            <Link to="/formeditor" className="link">
              AddBLOG
            </Link>
          </li>
        ) : null}
      ...
      <button>
        <Link to="/signup" className="link">
          {storeContext.userEmailData === "" ? "SIGNUP" : "SIGNOUT"}
        </Link>
      </button>
      <img
        onClick={showNavbar}
        className="humburger"
        src="https://image.flaticon.com/icons/png/128/1828/1828859.png"
        width="30px"
        alt="hamburger"
      />
    </nav>
